...
import { FileInputChangeEvent } from "@bytescale/upload-widget/modules/common/FileInputChangeEvent";
...
export const UploadButton = ({
  ...
  const [inputId] = useState(`upload-widget__input-${Math.round(Math.random() * 1000000)}`);
